...
export class AddCodeEntregas1684343542769 implements MigrationInterface {
    name = 'AddCodeEntregas1684343542769'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "entregas" ("id" integer NOT NULL, "tokencoleta" character varying(255), "entrega" character varying(255), "obs" character varying(500), "telefone" character varying(20), "formadepagamento" character varying(15) DEFAULT '', "data" character varying(50), "msgwhats" boolean NOT NULL DEFAULT false, "codigo" character varying(10), CONSTRAINT "PK_b0bdf868c69c227aefd59085282" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "etapas" ("id" SERIAL NOT NULL, "telefone" character varying(20) NOT NULL, "etapa" character varying(5) NOT NULL, "ativado" boolean NOT NULL DEFAULT true, "codigo" character varying(10), CONSTRAINT "UQ_dd36673c5a83758f3d075edc774" UNIQUE ("telefone"), CONSTRAINT "PK_26de329bbb63ed9c4e4023b6c2f" PRIMARY KEY ("id"))`);
